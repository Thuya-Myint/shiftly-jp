...
function ShiftItem({ shift, theme, baseLang, onDelete, onUpdate }) {
    ...
    return (_jsxs("div", { className: cn("group relative overflow-hidden rounded-3xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer backdrop-blur-xl border", theme === 'light'
            ...
            : 'bg-slate-900/60 border-slate-700/50 hover:bg-slate-900/80'), ref: itemRef, children: [_jsx("div", { className: cn("absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500", "bg-gradient-to-br from-indigo-500/5 via-violet-500/5 to-purple-500/5") }), _jsxs("div", { className: "flex flex-col lg:flex-row justify-between items-start relative z-10 gap-3 sm:gap-4 lg:gap-0", children: [_jsxs("div", { className: "flex flex-col space-y-3 sm:space-y-4 w-full lg:w-auto", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-2 sm:gap-3", children: [_jsx("span", { className: cn("text-sm font-bold px-3 py-2 rounded-xl shadow-sm", PRIMARY_COLOR_CLASSES.bgLight, "dark:bg-violet-900/40", PRIMARY_COLOR_CLASSES.text), children: displayDayOfWeek }), _jsx("span", { className: "text-sm font-semibold px-3 py-2 rounded-xl bg-gray-100/80 dark:bg-slate-700/60 text-gray-900 dark:text-gray-100 shadow-sm backdrop-blur-sm", children: shift.date }), _jsxs("button", { onClick: () => setShiftLang(shiftLang === 'en' ? 'jp' : 'en'), className: cn("text-sm font-medium px-3 py-2 rounded-xl border-2 backdrop-blur-sm transition-all duration-300", PRIMARY_COLOR_CLASSES.border, PRIMARY_COLOR_CLASSES.text, "hover:shadow-md", theme === 'light' ? 'bg-white/60' : 'bg-slate-800/60'), "aria-label": "Translate shift details", children: [_jsx(Globe, { size: 14, className: "inline mr-2" }), shiftLang === 'en' ? 'JP' : 'EN'] })] }), _jsx("div", { className: "flex items-baseline gap-4", children: _jsxs("div", { className: "flex items-baseline gap-3", children: [_jsx("span", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: shift.fromTime }), _jsx("span", { className: cn("text-lg font-medium", PRIMARY_COLOR_CLASSES.text), children: "\u2192" }), _jsx("span", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: shift.toTime })] }) }), _jsxs("p", { className: "text-sm text-gray-700 dark:text-gray-300 font-medium", children: [shift.hours, " ", strings.hours, " @ \u00A5", shift.wage.toLocaleString(), "/", strings.hours === 'hours' ? 'h' : '時間'] })] }), _jsxs("div", { className: "flex flex-col items-start lg:items-end space-y-3 sm:space-y-4 w-full lg:w-auto", children: [_jsx("div", { className: cn("px-4 py-2 rounded-2xl shadow-lg backdrop-blur-sm", PRIMARY_COLOR_CLASSES.bgGradient), children: _jsx("p", { className: "text-2xl font-black text-white", children: yen.format(shift.pay) }) }), _jsxs("div", { className: "flex flex-wrap gap-2 sm:gap-3 w-full lg:w-auto justify-start lg:justify-end", children: [_jsxs(Button, { variant: "outline", size: "sm", className: cn("h-10 px-4 text-sm font-semibold rounded-xl border-2 backdrop-blur-sm transition-all duration-300 shadow-sm hover:shadow-md", PRIMARY_COLOR_CLASSES.border, PRIMARY_COLOR_CLASSES.text, theme === 'light' ? 'bg-white/60 hover:bg-white/80' : 'bg-slate-800/60 hover:bg-slate-800/80'), onClick: () => onUpdate(shift), children: [_jsx(RotateCcw, { size: 16, className: "mr-2" }), " ", strings.update] }), _jsxs(Button, { variant: "outline", size: "sm", className: "h-10 px-4 text-sm font-semibold rounded-xl border-2 border-red-300 dark:border-red-600 text-red-600 dark:text-red-400 bg-white/60 dark:bg-slate-800/60 hover:bg-red-50 dark:hover:bg-red-900/20 backdrop-blur-sm transition-all duration-300 shadow-sm hover:shadow-md", onClick: handleDelete, children: [_jsx(Trash2, { size: 16, className: "mr-2" }), " ", strings.delete] })] })] })] })] }, shift.id));
}
