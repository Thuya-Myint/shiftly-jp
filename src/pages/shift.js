...
function ScrollColumn({ options, selected, onSelect }) {
    ...
    return (_jsxs("div", { className: "relative group ", children: [_jsx("div", { className: cn("absolute top-[40px] left-0 right-0 h-[40px] rounded-lg pointer-events-none z-0", PRIMARY_COLOR_CLASSES.bgLight + '/50 dark:' + PRIMARY_COLOR_CLASSES.bgDark) }), _jsxs("div", { ref: containerRef, onScroll: handleScroll, style: { height: `${CONTAINER_HEIGHT}px` }, className: "overflow-y-auto no-scrollbar relative z-10 w-14", children: [_jsx("div", { style: { height: `${ITEM_HEIGHT}px` } }), options.map((o, idx) => {
                        ...
                        return (_jsx("div", { style: { height: `${ITEM_HEIGHT}px` }, onClick: () => {
                                ...
                                : "text-gray-400 dark:text-gray-400 text-base scale-100"), children: o }, idx));
...
function ScrollTimePicker({ value, onChange, label }) {
    ...
    return (_jsxs("div", { className: "flex flex-col items-center", children: [_jsxs("div", { className: "flex items-center justify-center gap-2 p-2 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800", children: [_jsx(ScrollColumn, { options: hours, selected: hour, onSelect: (h) => updateTime(h, minute) }), _jsx("span", { className: "text-gray-300 dark:text-gray-600 pb-1 text-xl", children: ":" }), _jsx(ScrollColumn, { options: minutes, selected: minute, onSelect: (m) => updateTime(hour, m) })] }), label && _jsx("p", { className: "mt-2 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400", children: label })] }));
}
...
function ThemeDropdown({ theme, setTheme, variantIndex, setVariantIndex, toggleLang }) {
    ...
    return (_jsxs("div", { className: "relative flex gap-2 ", ref: dropdownRef, children: [_jsx(motion.button, { onClick: handleThemeIconClick, whileTap: { scale: 0.95 }, className: cn("p-3 rounded-full cursor-pointer", frostedGlassClasses), "aria-label": "Change theme", children: isOpen || isLight ? _jsx(Sun, { size: 18, className: "text-orange-500" }) : _jsx(Moon, { size: 18, className: "text-indigo-400" }) }), _jsx(motion.button, { onClick: toggleLang, whileTap: { scale: 0.95 }, className: cn("p-3 rounded-full cursor-pointer", frostedGlassClasses), "aria-label": "Toggle language", children: _jsx(Globe, { size: 18, className: PRIMARY_COLOR_CLASSES.text }) }), _jsx(AnimatePresence, { children: isOpen && (_jsxs(motion.div, { initial: { opacity: 0, y: -20, scale: 0.9 }, animate: { opacity: 1, y: 0, scale: 1 }, exit: { opacity: 0, y: -20, scale: 0.9 }, transition: { type: "spring", stiffness: 400, damping: 25 }, 
                    // 🚨 THE Z-INDEX FIX: Replaced inline style with high Tailwind utility class
                    className: cn(`absolute right-0 top-full mt-2 w-80 rounded-xl p-4 origin-top-right shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10`, isLight ? 'bg-white' : 'bg-slate-950', 'z-[9999]'), children: [_jsxs("div", { className: `flex justify-between items-center mb-3 p-1 rounded-lg ${isLight ? 'bg-gray-100' : 'bg-slate-800'}  `, children: [_jsxs(motion.button, { onClick: () => handleToggleTheme('light'), className: cn("flex-1 px-3 py-2 rounded-lg cursor-pointer text-sm font-medium transition-colors", isLight ? 'bg-white shadow-md text-slate-800' : 'text-gray-500 dark:text-gray-400'), children: [_jsx(Sun, { size: 16, className: "inline mr-1" }), " Light"] }), _jsxs(motion.button, { onClick: () => handleToggleTheme('dark'), className: cn("flex-1 px-3 py-2 rounded-lg text-sm cursor-pointer font-medium transition-colors", !isLight ? 'bg-slate-700 shadow-md text-white' : 'text-gray-500 dark:text-gray-400'), children: [_jsx(Moon, { size: 16, className: "inline mr-1" }), " Dark"] })] }), _jsx("h3", { className: "text-xs font-bold uppercase text-gray-400 dark:text-gray-500 mb-2 px-1", children: "Color Palette" }), _jsx("div", { className: `space-y-0 flex flex-col p-2 overflow-y-auto no-scrollbar`, children: THEME_VARIANTS.map((variant, index) => (_jsxs(motion.div, { onClick: () => handleSelectVariant(index), className: cn("flex items-center justify-between p-2 rounded-lg cursor-pointer transition-all", 
...
function MonthFilter({ selectedMonth, onMonthSelect, lang }) {
    ...
    return (_jsxs("div", { className: "relative flex-1", children: [_jsxs(Button, { onClick: () => setIsOpen(!isOpen), variant: "outline", className: cn("w-full h-12 px-4 flex items-center justify-between rounded-xl border-2 font-medium transition-all", selectedMonth
                    ? cn(PRIMARY_COLOR_CLASSES.border, PRIMARY_COLOR_CLASSES.text, "bg-white dark:bg-slate-900/80")
                    : "border-gray-300 dark:border-slate-600 bg-white/80 dark:bg-slate-900/60 text-gray-600 dark:text-gray-400"), children: [_jsxs("div", { className: "flex items-center", children: [_jsx(CalendarIcon, { size: 16, className: "mr-2" }), _jsx("span", { className: "text-sm", children: selectedMonth ? format(selectedMonth, lang === 'en' ? 'MMM yyyy' : 'yyyy年M月') : strings.filterByMonth })] }), selectedMonth && _jsx(X, { size: 16, className: "opacity-50", onClick: (e) => { e.stopPropagation(); onMonthSelect(undefined); } })] }), _jsx(AnimatePresence, { children: isOpen && (_jsx(motion.div, { initial: { opacity: 0, y: -10, scale: 0.95 }, animate: { opacity: 1, y: 0, scale: 1 }, exit: { opacity: 0, y: -10, scale: 0.95 }, transition: { type: "spring", stiffness: 400, damping: 30 }, 
                    ...
                    style: { zIndex: 9999 }, className: "absolute top-full mt-2 w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-200/50 dark:border-slate-700/50 max-h-60 overflow-y-auto", children: _jsxs("div", { className: "p-2", children: [_jsx(motion.button, { onClick: () => handleSelectMonth(undefined), whileHover: { scale: 1.02, backgroundColor: "rgba(99, 102, 241, 0.1)" }, whileTap: { scale: 0.98 }, className: "w-full text-left px-3 py-2 rounded-lg text-sm font-medium text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors", children: strings.allMonths }), allShiftMonths.map((monthStr) => (_jsx(motion.button, { onClick: () => handleSelectMonth(monthStr), whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, className: cn("w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors", selectedMonth && format(selectedMonth, 'yyyy-MM') === monthStr
                                    ...
                                    : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"), children: format(parseISO(monthStr + '-01'), lang === 'en' ? 'MMM yyyy' : 'yyyy年M月') }, monthStr)))] }) })) })] }));
}
function AddEditShiftModal({ isOpen, onClose, onSubmit, initialShift, lang }) {
    ...
    return (_jsx(AnimatePresence, { children: isOpen && (_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, className: "fixed inset-0 z-[10000] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4", onClick: onClose, children: _jsxs(motion.div, { initial: { scale: 0.9, y: 50 }, animate: { scale: 1, y: 0 }, exit: { scale: 0.9, y: 50 }, transition: { type: "spring", stiffness: 300, damping: 30 }, className: cn("w-full max-w-md rounded-3xl p-6 relative", modalBgClasses), onClick: (e) => e.stopPropagation(), children: [_jsx("h2", { className: cn("text-2xl font-extrabold mb-6", PRIMARY_COLOR_CLASSES.text), children: title }), _jsx(Button, { variant: "ghost", size: "icon", className: "absolute top-4 right-4 h-10 w-10 text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200", onClick: onClose, "aria-label": "Close modal", children: _jsx(X, { size: 20 }) }), _jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2", children: lang === 'en' ? 'Date' : '日付' }), _jsxs(Popover, { open: isDatePopoverOpen, onOpenChange: setIsDatePopoverOpen, children: [_jsx(PopoverTrigger, { asChild: true, children: _jsxs(Button, { variant: "outline", className: cn("w-full justify-start text-left font-normal h-12 rounded-xl border-2", PRIMARY_COLOR_CLASSES.border), children: [_jsx(CalendarIcon, { className: cn("mr-2 h-4 w-4", PRIMARY_COLOR_CLASSES.text) }), form.date ? format(form.date, lang === 'en' ? 'PPP' : 'yyyy年M月d日(EEE)') : _jsx("span", { children: "Pick a date" })] }) }), _jsx(PopoverContent, { className: "w-auto p-0 z-[10001]", children: _jsx(Calendar, { mode: "single", selected: form.date, onSelect: handleDateSelect, initialFocus: true, locale: lang === 'jp' ? undefined : undefined }) })] })] }), _jsxs("div", { className: "flex justify-around items-center gap-4 py-2", children: [_jsx(ScrollTimePicker, { value: form.fromTime, onChange: (v) => handleTimeChange('fromTime', v), label: strings.start }), _jsx("span", { className: cn("text-2xl font-bold pt-4", PRIMARY_COLOR_CLASSES.text), children: strings.to }), _jsx(ScrollTimePicker, { value: form.toTime, onChange: (v) => handleTimeChange('toTime', v), label: strings.end })] }), _jsxs("div", { children: [_jsxs("label", { htmlFor: "wage", className: "block text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2", children: [_jsx(Zap, { size: 14, className: "inline mr-1" }), " ", strings.hourlyRate, " (", lang === 'en' ? 'JPY' : '円', ")"] }), _jsxs("div", { className: "relative", children: [_jsx(Input, { id: "wage", name: "wage", type: "number", step: "100", placeholder: "1000", value: form.wage, onChange: handleChange, className: cn("w-full h-12 rounded-xl text-lg font-semibold pl-10 border-2", PRIMARY_COLOR_CLASSES.border) }), _jsx("span", { className: cn("absolute left-3 top-1/2 transform -translate-y-1/2 text-lg font-bold", PRIMARY_COLOR_CLASSES.text), children: "\u00A5" })] })] }), _jsxs(motion.div, { className: cn("p-4 rounded-xl flex justify-between items-center shadow-md", PRIMARY_COLOR_CLASSES.bgLight + '/50 dark:' + PRIMARY_COLOR_CLASSES.bgDark), initial: { scale: 0.95 }, animate: { scale: 1 }, transition: { type: "spring", stiffness: 400, damping: 25 }, children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-500 dark:text-gray-400", children: strings.totalHours }), _jsxs("p", { className: cn("text-2xl font-black", PRIMARY_COLOR_CLASSES.text), children: [hours, " ", strings.hours] })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-500 dark:text-gray-400", children: strings.totalPay }), _jsx("p", { className: cn("text-2xl font-black", PRIMARY_COLOR_CLASSES.text), children: yen.format(pay) })] })] }), _jsx(motion.button, { type: "submit", className: cn("w-full h-12 rounded-xl text-lg font-bold text-white transition-all shadow-lg hover:shadow-xl", PRIMARY_COLOR_CLASSES.bgGradient), whileTap: { scale: 0.98 }, children: submitText })] })] }) })) }));
}
// --- MAIN APP COMPONENT ---
export default function ShiftTracker() {
    ...
    const appClasses = theme === 'light'
        ? themeVariant.light
        : themeVariant.dark;
    return (_jsxs(_Fragment, { children: [_jsx(GlobalStyles, {}), _jsxs("div", { className: cn("min-h-screen", appClasses), children: [_jsxs("div", { className: cn("min-h-screen flex flex-col items-center p-4 sm:p-6 transition-colors duration-500"), children: [_jsxs("header", { className: "w-full max-w-4xl sticky top-0 z-40 mb-6 py-4 backdrop-blur-md bg-transparent/80", children: [_jsxs("div", { className: "flex justify-between items-center mb-4", children: [_jsx("h1", { className: cn("text-3xl font-extrabold tracking-tight", PRIMARY_COLOR_CLASSES.text), children: "Shift Tracker" }), _jsxs("div", { className: "flex gap-2", children: [_jsx(ThemeDropdown, { theme: theme, setTheme: setTheme, variantIndex: variantIndex, setVariantIndex: setVariantIndex, toggleLang: toggleLang }), _jsx(motion.button, { onClick: openAddModal, whileTap: { scale: 0.95 }, className: cn("p-3 rounded-full cursor-pointer backdrop-blur-md border shadow-sm transition-colors", PRIMARY_COLOR_CLASSES.bgGradient, "text-white"), "aria-label": "Add new shift", children: _jsx(Plus, { size: 18 }) })] })] }), _jsxs("div", { className: cn("p-4 rounded-2xl shadow-xl flex flex-col sm:flex-row justify-between items-center gap-4 border", theme === 'light'
                                            ? 'bg-white/80 border-gray-200'
                                            : 'bg-slate-900/70 border-slate-700'), children: [_jsxs("div", { className: "flex flex-col items-start", children: [_jsx("p", { className: "text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400", children: strings.grandTotal }), _jsx("p", { className: cn("text-3xl font-black", PRIMARY_COLOR_CLASSES.text), children: yen.format(aggregatedData.grandTotal.totalPay) }), _jsxs("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: [aggregatedData.grandTotal.totalHours, " ", strings.hours] })] }), _jsxs("div", { className: "flex gap-3 w-full sm:w-auto", children: [_jsx(MonthFilter, { selectedMonth: filterMonth, onMonthSelect: setFilterMonth, lang: lang }), _jsx(Button, { onClick: () => setViewMode(prev => prev === 'list' ? 'monthly' : 'list'), variant: "outline", className: cn("h-12 px-4 rounded-xl border-2 transition-all", viewMode === 'list'
