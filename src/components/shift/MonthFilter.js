...
export function MonthFilter({ selectedMonth, onMonthSelect, lang, primaryColors, }) {
    ...
    return (_jsx("div", { className: "flex-1 min-w-0", children: _jsxs(Popover, { open: open, onOpenChange: setOpen, children: [_jsx(PopoverTrigger, { asChild: true, children: _jsxs(Button, { variant: "outline", className: cn("w-full h-10 sm:h-12 px-3 sm:px-4 flex items-center justify-between rounded-xl border-2 font-medium text-sm", selectedMonth
                            ...
                            : "border-gray-300 dark:border-slate-600 text-gray-500"), children: [_jsxs("div", { className: "flex items-center truncate", children: [_jsx(CalendarIcon, { size: 16, className: "mr-2" }), selectedMonth
                                ...
                                return (_jsx(Button, { variant: "ghost", onClick: () => {
                                    ...
                                    }, className: cn("h-9 text-sm rounded-lg", isSelected
