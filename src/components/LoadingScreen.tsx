...
export function LoadingScreen() {
    ...
    return (
        ...
        >
            ...
            >
                {/* Enhanced Fluid loading animation */}
                <div className="relative w-32 h-32 mx-auto mb-10">
                    {/* Outer glow ring */}
                    <motion.div
                        animate={{ rotate: 360, scale: [1, 1.1, 1] }}
                        transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
                        className={cn("absolute inset-0 border-4 border-transparent rounded-full shadow-2xl", PRIMARY_COLOR_CLASSES.bgGradient)}
                        style={{
                            borderTopColor: 'transparent',
                            filter: `drop-shadow(0 0 20px ${spinnerColor}40) drop-shadow(0 0 40px ${spinnerColor}20)`
                        }}
                    />
                    ...
                    <motion.div
                        ...
                        className={cn("absolute inset-2 border-3 border-transparent rounded-full opacity-80", PRIMARY_COLOR_CLASSES.bgGradient)}
                        style={{
                            borderRightColor: 'transparent',
                            filter: `drop-shadow(0 0 15px ${spinnerColor}60)`
                        }}
                    />
                    {/* Inner pulsing core */}
                    <motion.div
                        ...
                        className={cn("absolute inset-8 rounded-full", PRIMARY_COLOR_CLASSES.bgGradient)}
                        style={{
                            filter: `drop-shadow(0 0 25px ${spinnerColor}80) blur(0.5px)`
                        }}
                    />
                    {/* Outer glow effect */}
                    <motion.div
                        ...
                        style={{
                            background: `radial-gradient(circle, ${spinnerColor}20 0%, transparent 70%)`,
                            filter: 'blur(8px)'
                        }}
                    />
